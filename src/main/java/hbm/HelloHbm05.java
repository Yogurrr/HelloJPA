...
public class HelloHbm05 {
    public static void main(String[] args) {
        ...
        try {
            ...
            // 조회 - 부분 조회 : 이름, 연봉, setProjection
            /*Criteria query = sess.createCriteria(Employee.class);
            query.setProjection(Projections.projectionList().add(Projections.property("fname"))
            ...
            /*Criteria query = sess.createCriteria(Employee.class);
            query.add(Expression.gt("sal", 20000));
            List<Employee> emps = query.list();
            ...
            // 서브 쿼리 : 부서명이 IT인 사원들의 이름, 직책, 입사일 조회
            ...
            query.setFetchMode("emp.depoartment", FetchMode.JOIN);
            query.createCriteria("emp.department", "dept");
            ...
            if (jobid != null) query.add(Expression.eq("jobid", jobid));
